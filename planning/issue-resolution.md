...
- Optional MCP 2.x service accepts JSON Schema contracts and confines file access to a configured root; PDF selection precedes rendering. Docker and Compose provide a local deployment.
